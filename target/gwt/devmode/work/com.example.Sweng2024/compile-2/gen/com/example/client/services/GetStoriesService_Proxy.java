...
public class GetStoriesService_Proxy extends RemoteServiceProxy implements com.example.client.services.GetStoriesServiceAsync {
  ...
  private static final String SERIALIZATION_POLICY ="20CF8A9C2472D5B362C77A40433BF5B1";
  ...
  public void loadCurrentStory(java.lang.String username, com.example.shared.Story story, com.google.gwt.user.client.rpc.AsyncCallback async) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("GetStoriesService_Proxy", "loadCurrentStory");
    try {
  ...
  public void modifyStoryByName(com.example.shared.Story story, com.google.gwt.user.client.rpc.AsyncCallback async) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("GetStoriesService_Proxy", "modifyStoryByName");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 1);
      streamWriter.writeString("com.example.shared.Story/3596774059");
      streamWriter.writeObject(story);
  ...
  public void saveCurrentStory(java.lang.String username, com.example.shared.Story story, com.example.shared.Scenario currentScenario, com.google.gwt.user.client.rpc.AsyncCallback async) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("GetStoriesService_Proxy", "saveCurrentStory");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 3);
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeString("com.example.shared.Story/3596774059");
      streamWriter.writeString("com.example.shared.Scenario/1673370721");
      streamWriter.writeString(username);
      streamWriter.writeObject(story);
      streamWriter.writeObject(currentScenario);
      helper.finish(async, ResponseReader.BOOLEAN);
    } catch (SerializationException ex) {
      async.onFailure(ex);
    }
