...
public class GetStoriesService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    var result = {};
    result["com.example.client.Pair/1329617889"] = [
        @com.example.client.Pair_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.example.client.Pair_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/example/client/Pair;),
      ];
    
    result["com.example.shared.Scenario/1673370721"] = [
        @com.example.shared.Scenario_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.example.shared.Scenario_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/example/shared/Scenario;),
        @com.example.shared.Scenario_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/example/shared/Scenario;)
      ];
    
    result["com.example.shared.Story/3596774059"] = [
        @com.example.shared.Story_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.example.shared.Story_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/example/shared/Story;),
        @com.example.shared.Story_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/example/shared/Story;)
      ];
    
    result["[Lcom.example.shared.Story;/2312282962"] = [
        @com.example.shared.Story_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.example.shared.Story_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/example/shared/Story;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    var result = [];
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.example.client.Pair::class)] = "com.example.client.Pair/1329617889";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.example.shared.Scenario::class)] = "com.example.shared.Scenario/1673370721";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.example.shared.Story::class)] = "com.example.shared.Story/3596774059";
    result[@javaemul.internal.HashCodes::getObjectIdentityHashCode(*)(@com.example.shared.Story[]::class)] = "[Lcom.example.shared.Story;/2312282962";
  ...
  public GetStoriesService_TypeSerializer() {
