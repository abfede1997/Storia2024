...
function Q2e_g$(app_0_g$){
  ...
  vPanel2a_0_g$.add_4_g$(signupLink_0_g$);
...
function _4e_g$(){
  ...
  Wb_g$.call(this);
  this.$init_1379_g$();
  titolo_0_g$ = new RZc_g$('Effettua il pagamento per poter giocare.');
  amount1TextBox_0_g$ = new Ncd_g$;
  amount2TextBox_0_g$ = new Ncd_g$;
  amount3TextBox_0_g$ = new Ncd_g$;
  amount4TextBox_0_g$ = new Ncd_g$;
  amount5TextBox_0_g$ = new Ncd_g$;
  sendButton_0_g$ = new ZRc_g$('Invia');
  sendButton_0_g$.addClickHandler_0_g$(new c5e_g$(this, amount1TextBox_0_g$, amount2TextBox_0_g$, amount3TextBox_0_g$, amount4TextBox_0_g$, amount5TextBox_0_g$));
  this.vPanel_1_g$.add_4_g$(titolo_0_g$);
  this.vPanel_1_g$.add_4_g$(new RZc_g$('Amount:'));
  this.vPanel_1_g$.add_4_g$(amount1TextBox_0_g$);
  this.vPanel_1_g$.add_4_g$(new RZc_g$('Card Holder:'));
  this.vPanel_1_g$.add_4_g$(amount2TextBox_0_g$);
  this.vPanel_1_g$.add_4_g$(new RZc_g$('Card Number:'));
  this.vPanel_1_g$.add_4_g$(amount3TextBox_0_g$);
  this.vPanel_1_g$.add_4_g$(new RZc_g$('Expire Date:'));
  this.vPanel_1_g$.add_4_g$(amount4TextBox_0_g$);
  this.vPanel_1_g$.add_4_g$(new RZc_g$('CVV:'));
  this.vPanel_1_g$.add_4_g$(amount5TextBox_0_g$);
  this.vPanel_1_g$.add_4_g$(sendButton_0_g$);
  this.initWidget_0_g$(this.vPanel_1_g$);
}

nnc_g$(2037, 1125, {2037:1, 815:1, 838:1, 1025:1, 1125:1, 1194:1, 1211:1, 1213:1, 1334:1, 1348:1, 1:1}, _4e_g$);
_.$init_1379_g$ = function $4e_g$(){
  Z4e_g$();
  this.vPanel_1_g$ = new Zod_g$;
}
;
var Lcom_example_client_PagaPage_2_classLit_0_g$ = Syd_g$('com.example.client', 'PagaPage', 2037, Lcom_google_gwt_user_client_ui_Composite_2_classLit_0_g$);
function a5e_g$(){
  a5e_g$ = Object;
  a_g$();
}

function c5e_g$(this$0_0_g$, val$amount1TextBox_0_g$, val$amount2TextBox_0_g$, val$amount3TextBox_0_g$, val$amount4TextBox_0_g$, val$amount5TextBox_0_g$){
  a5e_g$();
...
nnc_g$(2038, 1, {2038:1, 697:1, 831:1, 1:1}, c5e_g$);
_.$init_1380_g$ = function b5e_g$(){
  a5e_g$();
}
;
_.onClick_0_g$ = function d5e_g$(event_0_g$){
  var builder_0_g$, e_0_g$, payload_0_g$;
  payload_0_g$ = new y6e_g$;
  payload_0_g$.put_6_g$('amount', new o7e_g$(this.val$amount1TextBox2_0_g$.getText_0_g$()));
  payload_0_g$.put_6_g$('card_holder', new o7e_g$(this.val$amount2TextBox3_0_g$.getText_0_g$()));
  payload_0_g$.put_6_g$('card_number', new o7e_g$(this.val$amount3TextBox4_0_g$.getText_0_g$()));
  payload_0_g$.put_6_g$('expire_date', new o7e_g$(this.val$amount4TextBox5_0_g$.getText_0_g$()));
  payload_0_g$.put_6_g$('cvv', new o7e_g$(this.val$amount5TextBox6_0_g$.getText_0_g$()));
  builder_0_g$ = new o9b_g$((m9b_g$() , POST_0_g$), 'http://localhost:6789/pay');
  builder_0_g$.setHeader_0_g$('Content-Type', 'application/json');
  try {
    builder_0_g$.sendRequest_0_g$(payload_0_g$.toString_1_g$(), new g5e_g$(this));
  }
   catch ($e0_0_g$) {
    $e0_0_g$ = Ylc_g$($e0_0_g$);
    if (Zkc_g$($e0_0_g$, 856)) {
      e_0_g$ = $e0_0_g$;
      sGc_g$('Errore durante la creazione della richiesta. Riprova pi\xF9 tardi.');
    }
     else 
      throw Zlc_g$($e0_0_g$);
  }
...
;
var Lcom_example_client_PagaPage$1_2_classLit_0_g$ = Syd_g$('com.example.client', 'PagaPage/1', 2038, Ljava_lang_Object_2_classLit_0_g$);
function e5e_g$(){
  e5e_g$ = Object;
  a_g$();
}

function g5e_g$(this$1_0_g$){
  e5e_g$();
...
nnc_g$(2039, 1, {2039:1, 855:1, 1:1}, g5e_g$);
_.$init_1381_g$ = function f5e_g$(){
  e5e_g$();
}
;
_.onError_1_g$ = function h5e_g$(request_0_g$, exception_0_g$){
  sGc_g$("Errore durante l'invio della richiesta. Riprova pi\xF9 tardi.");
}
;
_.onResponseReceived_0_g$ = function i5e_g$(request_0_g$, response_0_g$){
  if (response_0_g$.getStatusCode_0_g$() == 200) {
    sGc_g$('Transazione completata con successo!');
  }
   else {
    sGc_g$('Errore durante la transazione. Riprova pi\xF9 tardi.');
  }
}
;
var Lcom_example_client_PagaPage$1$1_2_classLit_0_g$ = Syd_g$('com.example.client', 'PagaPage/1/1', 2039, Ljava_lang_Object_2_classLit_0_g$);
function _2e_g$(){
  _2e_g$ = Object;
  Ub_g$();
}
...
function b3e_g$(app_0_g$){
  ...
  vPanel2a_0_g$.add_4_g$(loginLink_0_g$);
...
_.handleHistoryChange_0_g$ = function n3e_g$(historyToken_0_g$){
  ...
  if (JHd_g$('home', historyToken_0_g$)) {
   ...
   else if (JHd_g$('pagaPage', historyToken_0_g$)) {
...
;
_.showPagaPage_0_g$ = function j5e_g$(){
  vc_g$();
  var pagaPage_0_g$;
  Ted_g$().clear_0_g$();
  pagaPage_0_g$ = new _4e_g$;
  Ted_g$().add_4_g$(pagaPage_0_g$);
}
;
...
nnc_g$(2049, 1, {2049:1, 1:1}, u5e_g$);
_.$init_1382_g$ = function t5e_g$(){
  s5e_g$();
}
;
_.isArray_1_g$ = function v5e_g$(){
  return null;
}
;
_.isBoolean_0_g$ = function w5e_g$(){
  return null;
}
;
_.isNull_0_g$ = function x5e_g$(){
  return null;
}
;
_.isNumber_0_g$ = function y5e_g$(){
  return null;
}
;
_.isObject_0_g$ = function z5e_g$(){
  return null;
}
;
_.isString_0_g$ = function A5e_g$(){
  return null;
}
;
var Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONValue', 2049, Ljava_lang_Object_2_classLit_0_g$);
function B5e_g$(){
  B5e_g$ = Object;
  s5e_g$();
}
...
function D5e_g$(){
  ...
  u5e_g$.call(this);
  this.$init_1383_g$();
  this.jsArray_0_g$ = zw_g$();
}

function E5e_g$(arr_0_g$){
  B5e_g$();
  u5e_g$.call(this);
  this.$init_1383_g$();
...
function P5e_g$(value_0_g$){
  B5e_g$();
  return value_0_g$.jsArray_0_g$;
}

nnc_g$(2040, 2049, {2040:1, 2049:1, 1:1}, D5e_g$, E5e_g$);
_.$init_1383_g$ = function C5e_g$(){
  B5e_g$();
}
;
_.equals_0_g$ = function F5e_g$(other_0_g$){
  if (!Zkc_g$(other_0_g$, 2040)) {
    return false;
  }
  return qw_g$(this.jsArray_0_g$, Jkc_g$(other_0_g$, 2040).jsArray_0_g$);
}
;
_.get_17_g$ = function G5e_g$(index_0_g$){
  var v_0_g$ = this.jsArray_0_g$[index_0_g$];
  var func_0_g$ = (Y6e_g$() , typeMap_0_g$)[typeof v_0_g$];
  return func_0_g$?func_0_g$(v_0_g$):l7e_g$(typeof v_0_g$);
}
;
_.getJavaScriptObject_0_g$ = function H5e_g$(){
  return this.jsArray_0_g$;
}
;
_.getUnwrapper_0_g$ = function I5e_g$(){
  return P5e_g$;
}
;
_.hashCode_1_g$ = function J5e_g$(){
  return sw_g$(this.jsArray_0_g$);
}
;
_.isArray_1_g$ = function K5e_g$(){
  return this;
}
;
_.set_47_g$ = function L5e_g$(index_0_g$, value_0_g$){
  var previous_0_g$;
  previous_0_g$ = this.get_17_g$(index_0_g$);
  this.set0_0_g$(index_0_g$, value_0_g$);
  return previous_0_g$;
}
;
_.set0_0_g$ = function M5e_g$(index_0_g$, value_0_g$){
  B5e_g$();
  if (value_0_g$) {
...
;
_.size_8_g$ = function N5e_g$(){
  return this.jsArray_0_g$.length;
}
;
_.toString_1_g$ = function O5e_g$(){
  ...
  for (i_0_g$ = 0 , c_0_g$ = this.size_8_g$(); i_0_g$ < c_0_g$; i_0_g$++) {
    ...
    sb_0_g$.append_33_g$(this.get_17_g$(i_0_g$));
  }
  sb_0_g$.append_34_g$(']');
  return sb_0_g$.toString_1_g$();
}
;
var Lcom_google_gwt_json_client_JSONArray_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONArray', 2040, Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$);
function Q5e_g$(){
  Q5e_g$ = Object;
  s5e_g$();
  FALSE_7_g$ = new S5e_g$(false);
  TRUE_7_g$ = new S5e_g$(true);
}

function S5e_g$(value_0_g$){
  Q5e_g$();
  u5e_g$.call(this);
  this.$init_1384_g$();
  this.value_34_g$ = value_0_g$;
}

function U5e_g$(b_0_g$){
  Q5e_g$();
  if (b_0_g$) {
    return TRUE_7_g$;
  }
...
function Y5e_g$(value_0_g$){
  Q5e_g$();
  return value_0_g$.value_34_g$;
}

nnc_g$(2041, 2049, {2041:1, 2049:1, 1:1}, S5e_g$);
_.$init_1384_g$ = function R5e_g$(){
  Q5e_g$();
}
;
_.booleanValue_0_g$ = function T5e_g$(){
  return this.value_34_g$;
}
;
_.getUnwrapper_0_g$ = function V5e_g$(){
  return Y5e_g$;
}
;
_.isBoolean_0_g$ = function W5e_g$(){
...
;
_.toString_1_g$ = function X5e_g$(){
  return fwd_g$(this.value_34_g$);
}
;
_.value_34_g$ = false;
var FALSE_7_g$, TRUE_7_g$;
var Lcom_google_gwt_json_client_JSONBoolean_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONBoolean', 2041, Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$);
function Z5e_g$(){
  Z5e_g$ = Object;
  iD_g$();
}
...
function a6e_g$(message_0_g$){
  Z5e_g$();
  mD_g$.call(this, message_0_g$);
  this.$init_1385_g$();
}

function b6e_g$(message_0_g$, cause_0_g$){
  Z5e_g$();
  nD_g$.call(this, message_0_g$, cause_0_g$);
  this.$init_1385_g$();
}

function c6e_g$(cause_0_g$){
  Z5e_g$();
  pD_g$.call(this, cause_0_g$);
  this.$init_1385_g$();
}

nnc_g$(2042, 1466, {2042:1, 1400:1, 1435:1, 1:1, 1466:1, 1480:1}, _5e_g$, a6e_g$, b6e_g$, c6e_g$);
_.$init_1385_g$ = function $5e_g$(){
  Z5e_g$();
}
;
var Lcom_google_gwt_json_client_JSONException_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONException', 2042, Ljava_lang_RuntimeException_2_classLit_0_g$);
function d6e_g$(){
  d6e_g$ = Object;
  s5e_g$();
  instance_6_g$ = new f6e_g$;
}
...
nnc_g$(2043, 2049, {2043:1, 2049:1, 1:1}, f6e_g$);
_.$init_1386_g$ = function e6e_g$(){
  d6e_g$();
}
;
_.getUnwrapper_0_g$ = function h6e_g$(){
  return k6e_g$;
}
;
_.isNull_0_g$ = function i6e_g$(){
  if (slc_g$(this, instance_6_g$)) {
    return null;
  }
  return this;
}
;
_.toString_1_g$ = function j6e_g$(){
  return 'null';
}
;
var instance_6_g$;
var Lcom_google_gwt_json_client_JSONNull_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONNull', 2043, Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$);
function l6e_g$(){
  l6e_g$ = Object;
  s5e_g$();
}

function n6e_g$(value_0_g$){
  l6e_g$();
  u5e_g$.call(this);
  this.$init_1387_g$();
  this.value_35_g$ = value_0_g$;
}

function v6e_g$(value_0_g$){
  l6e_g$();
  return value_0_g$.value_35_g$;
}

nnc_g$(2044, 2049, {2044:1, 2049:1, 1:1}, n6e_g$);
_.$init_1387_g$ = function m6e_g$(){
  l6e_g$();
}
;
_.doubleValue_1_g$ = function o6e_g$(){
  return this.value_35_g$;
}
;
_.equals_0_g$ = function p6e_g$(other_0_g$){
  if (!Zkc_g$(other_0_g$, 2044)) {
    return false;
  }
  return this.value_35_g$ == Jkc_g$(other_0_g$, 2044).value_35_g$;
}
;
_.getUnwrapper_0_g$ = function q6e_g$(){
  return v6e_g$;
}
;
_.getValue_2_g$ = function r6e_g$(){
  return this.value_35_g$;
}
;
_.hashCode_1_g$ = function s6e_g$(){
  return lAd_g$(EAd_g$(this.value_35_g$));
}
;
_.isNumber_0_g$ = function t6e_g$(){
  return this;
}
;
_.toString_1_g$ = function u6e_g$(){
  return this.value_35_g$ + '';
}
;
_.value_35_g$ = 0;
var Lcom_google_gwt_json_client_JSONNumber_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONNumber', 2044, Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$);
function w6e_g$(){
  w6e_g$ = Object;
  s5e_g$();
}
...
function y6e_g$(){
  w6e_g$();
  z6e_g$.call(this, Cw_g$());
}

function z6e_g$(jsValue_0_g$){
  w6e_g$();
  u5e_g$.call(this);
  this.$init_1388_g$();
...
function R6e_g$(value_0_g$){
  w6e_g$();
  return value_0_g$.jsObject_1_g$;
}

nnc_g$(2045, 2049, {2045:1, 2049:1, 1:1}, y6e_g$, z6e_g$);
_.$init_1388_g$ = function x6e_g$(){
  w6e_g$();
}
;
_.addAllKeys_0_g$ = function A6e_g$(s_0_g$){
  w6e_g$();
  var jsObject_0_g$ = this.jsObject_1_g$;
  for (var key_0_g$ in jsObject_0_g$) {
    if (jsObject_0_g$.hasOwnProperty(key_0_g$)) {
      s_0_g$.add_9_g$(key_0_g$);
    }
  }
}
;
_.computeKeys_0_g$ = function B6e_g$(){
  w6e_g$();
  var result_0_g$;
  if ($D_g$()) {
    return this.computeKeys0_0_g$(hjc_g$(Ljava_lang_String_2_classLit_0_g$, {1400:1, 1401:1, 1420:1, 1427:1, 1430:1, 1:1, 1463:1, 1478:1}, 2, 0, 6, 1));
  }
   else {
    result_0_g$ = new r5c_g$;
    this.addAllKeys_0_g$(result_0_g$);
    return Jkc_g$(result_0_g$.toArray_1_g$(hjc_g$(Ljava_lang_String_2_classLit_0_g$, {1400:1, 1401:1, 1420:1, 1427:1, 1430:1, 1:1, 1463:1, 1478:1}, 2, result_0_g$.size_8_g$(), 6, 1)), 1478);
  }
}
;
_.computeKeys0_0_g$ = function C6e_g$(result_0_g$){
  w6e_g$();
  var jsObject_0_g$ = this.jsObject_1_g$;
  var i_0_g$ = 0;
  for (var key_0_g$ in jsObject_0_g$) {
...
;
_.computeSize_0_g$ = function D6e_g$(){
  w6e_g$();
  var jsObject_0_g$ = this.jsObject_1_g$;
  var size_0_g$ = 0;
  for (var key_0_g$ in jsObject_0_g$) {
...
;
_.containsKey_1_g$ = function E6e_g$(key_0_g$){
  return key_0_g$ in this.jsObject_1_g$;
}
;
_.equals_0_g$ = function F6e_g$(other_0_g$){
  if (!Zkc_g$(other_0_g$, 2045)) {
    return false;
  }
  return qw_g$(this.jsObject_1_g$, Jkc_g$(other_0_g$, 2045).jsObject_1_g$);
}
;
_.get_18_g$ = function G6e_g$(key_0_g$){
...
;
_.get0_0_g$ = function H6e_g$(key_0_g$){
  w6e_g$();
  var jsObject_0_g$ = this.jsObject_1_g$;
  var v_0_g$;
  ...
  var func_0_g$ = (Y6e_g$() , typeMap_0_g$)[typeof v_0_g$];
  var ret_0_g$ = func_0_g$?func_0_g$(v_0_g$):l7e_g$(typeof v_0_g$);
  return ret_0_g$;
}
;
_.getJavaScriptObject_0_g$ = function I6e_g$(){
  return this.jsObject_1_g$;
}
;
_.getUnwrapper_0_g$ = function J6e_g$(){
  return R6e_g$;
}
;
_.hashCode_1_g$ = function K6e_g$(){
  return sw_g$(this.jsObject_1_g$);
}
;
_.isObject_0_g$ = function L6e_g$(){
  return this;
}
;
_.keySet_2_g$ = function M6e_g$(){
  var keys_0_g$;
  keys_0_g$ = this.computeKeys_0_g$();
  return new U6e_g$(this, keys_0_g$);
}
;
_.put_6_g$ = function N6e_g$(key_0_g$, jsonValue_0_g$){
  var previous_0_g$;
  if (rlc_g$(key_0_g$, null)) {
    throw Zlc_g$(new pEd_g$);
  }
  previous_0_g$ = this.get_18_g$(key_0_g$);
  this.put0_0_g$(key_0_g$, jsonValue_0_g$);
  return previous_0_g$;
}
;
_.put0_0_g$ = function O6e_g$(key_0_g$, value_0_g$){
  w6e_g$();
  if (value_0_g$) {
    var func_0_g$ = value_0_g$.getUnwrapper_0_g$();
...
;
_.size_8_g$ = function P6e_g$(){
  return this.computeSize_0_g$();
}
;
_.toString_1_g$ = function Q6e_g$(){
  ...
  for (key$array_0_g$ = keys_0_g$ , key$index_0_g$ = 0 , key$max_0_g$ = key$array_0_g$.length; key$index_0_g$ < key$max_0_g$; ++key$index_0_g$) {
    ...
    sb_0_g$.append_34_g$(rJ_g$(key_0_g$));
    sb_0_g$.append_34_g$(':');
    sb_0_g$.append_33_g$(this.get_18_g$(key_0_g$));
  }
  sb_0_g$.append_34_g$('}');
  return sb_0_g$.toString_1_g$();
}
;
var Lcom_google_gwt_json_client_JSONObject_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONObject', 2045, Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$);
function Y6e_g$(){
  Y6e_g$ = Object;
  a_g$();
  typeMap_0_g$ = f7e_g$();
...
function _6e_g$(v_0_g$){
  Y6e_g$();
  return U5e_g$(v_0_g$);
}

function a7e_g$(v_0_g$){
  Y6e_g$();
  return new n6e_g$(v_0_g$);
}

function b7e_g$(o_0_g$){
  Y6e_g$();
  if (!o_0_g$) {
    return g6e_g$();
  }
  ...
  if (v_0_g$ !== o_0_g$) {
    ...
    return new E5e_g$(o_0_g$);
  }
   else {
    return new z6e_g$(o_0_g$);
  }
}

function c7e_g$(v_0_g$){
  Y6e_g$();
  return new o7e_g$(v_0_g$);
}
...
function e7e_g$(json_0_g$, strict_0_g$){
  Y6e_g$();
  var v_0_g$;
  if (strict_0_g$) {
    try {
      ...
      return k7e_g$('Error parsing JSON: ' + e_0_g$);
    }
  }
   else {
    json_0_g$ = qJ_g$(json_0_g$);
    try {
      v_0_g$ = eval('(' + json_0_g$ + ')');
    }
     catch (e_0_g$) {
...
function f7e_g$(){
  Y6e_g$();
  return {'boolean':_6e_g$, 'number':a7e_g$, 'string':c7e_g$, 'object':b7e_g$, 'function':b7e_g$, 'undefined':d7e_g$};
}

function g7e_g$(jsonString_0_g$){
  Y6e_g$();
  return i7e_g$(jsonString_0_g$);
}

function h7e_g$(jsonString_0_g$, strict_0_g$){
  Y6e_g$();
  var ex_0_g$;
  if (rlc_g$(jsonString_0_g$, null)) {
    throw Zlc_g$(new pEd_g$);
  }
  if (wId_g$(jsonString_0_g$) == 0) {
    throw Zlc_g$(new rBd_g$('empty argument'));
  }
  try {
    return e7e_g$(jsonString_0_g$, strict_0_g$);
  }
   catch ($e0_0_g$) {
    $e0_0_g$ = Ylc_g$($e0_0_g$);
    if (Zkc_g$($e0_0_g$, 247)) {
      ex_0_g$ = $e0_0_g$;
      throw Zlc_g$(new c6e_g$(ex_0_g$));
    }
     else 
      throw Zlc_g$($e0_0_g$);
  }
...
function i7e_g$(jsonString_0_g$){
  Y6e_g$();
  return h7e_g$(jsonString_0_g$, false);
}

function j7e_g$(jsonString_0_g$){
  Y6e_g$();
  return h7e_g$(jsonString_0_g$, true);
}

function k7e_g$(message_0_g$){
  Y6e_g$();
  throw Zlc_g$(new a6e_g$(message_0_g$));
}

function l7e_g$(typeString_0_g$){
  Y6e_g$();
  throw Zlc_g$(new a6e_g$("Unexpected typeof result '" + typeString_0_g$ + "'; please report this bug to the GWT team"));
}

nnc_g$(2047, 1, {2047:1, 1:1}, $6e_g$);
_.$init_1390_g$ = function Z6e_g$(){
  Y6e_g$();
}
;
var typeMap_0_g$;
var Lcom_google_gwt_json_client_JSONParser_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONParser', 2047, Ljava_lang_Object_2_classLit_0_g$);
function m7e_g$(){
  m7e_g$ = Object;
  s5e_g$();
}
...
function o7e_g$(value_0_g$){
  ...
  this.value_36_g$ = value_0_g$;
}

function v7e_g$(value_0_g$){
  m7e_g$();
  return value_0_g$.value_36_g$;
}

nnc_g$(2048, 2049, {2048:1, 2049:1, 1:1}, o7e_g$);
_.$init_1391_g$ = function n7e_g$(){
  m7e_g$();
}
;
_.equals_0_g$ = function p7e_g$(other_0_g$){
  if (!Zkc_g$(other_0_g$, 2048)) {
    return false;
  }
  return JHd_g$(this.value_36_g$, Jkc_g$(other_0_g$, 2048).value_36_g$);
}
;
_.getUnwrapper_0_g$ = function q7e_g$(){
  return v7e_g$;
}
;
_.hashCode_1_g$ = function r7e_g$(){
  return ZHd_g$(this.value_36_g$);
}
;
_.isString_0_g$ = function s7e_g$(){
  return this;
}
;
_.stringValue_0_g$ = function t7e_g$(){
  return this.value_36_g$;
}
;
_.toString_1_g$ = function u7e_g$(){
  return rJ_g$(this.value_36_g$);
}
;
var Lcom_google_gwt_json_client_JSONString_2_classLit_0_g$ = Syd_g$('com.google.gwt.json.client', 'JSONString', 2048, Lcom_google_gwt_json_client_JSONValue_2_classLit_0_g$);
function tjc_g$(){
  tjc_g$ = Object;
  a_g$();
  BITS01_0_g$ = 2 * 22;
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/sweng2024/1452F17889D84B4996BBAD3E89138C6F_sourcemap.json 
